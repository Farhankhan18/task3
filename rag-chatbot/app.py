...
st.set_page_config(page_title="Insightful AI", layout="wide")

st.markdown("""
# 🧙‍♂️ **Insightful AI: Get Answers from Your Documents**


### **How It Works:**

1. **🔐 Enter Your API Key:**  
   You'll need a Google API key to enable the chatbot to access Google's Generative AI models.  
...
def main():
    st.header("💁 **AI-Powered Document Chatbot**")
    ...
    with st.sidebar:
        ...
        if st.button("🛠️ Submit & Process", key="process_button") and api_key:  # Check if API key is provided before processing
